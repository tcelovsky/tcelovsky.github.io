...
*When building my first Sinatra application from scratch I realized that the biggest issue for me was where to start. I was most struggling with creating the structure of the application without the scaffolding of a lab or a gem. That's why I thought it would be most helpful to write my blog post as a step by step guide for building Sinatra app architecture from scratch. Let's dive in.* 
...
7. Make Rakefile and enter the following in the Rakefile:
